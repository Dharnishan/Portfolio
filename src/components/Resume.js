...
export default function Resume(){
    const config = {
        link: 'public\files\DharnishanManoharan.pdf'
    }
    return <section id='resume' className='flex flec-col md:flex-row flex bg-primary px-5'>
        ...
        <div className='px-20 w-1/2 flex justify-center'>
            <div className='flex flex-col justify-center'>
                ...
                <p className='text-white'>You can view my resume <a className='btn' href={config.link} download="DharnishanManoharan.pdf">Download</a> </p>
            </div>
