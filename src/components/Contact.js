        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                type="submit"
                className="bg-accent text-white px-8 py-3 rounded-full font-semibold hover:bg-accent/80 transition-all duration-300 shadow-lg"
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href={`mailto:${config.email}`} className="text-gray-600 hover:text-accent transition-colors">
                    {config.email}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href={`tel:${config.phone}`} className="text-gray-600 hover:text-accent transition-colors">
                    {config.phone}
                  </a>
                </div>
              </div>
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a
                  href="https://www.linkedin.com/in/manoharan-dharnishan/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#0077B5] text-white p-3 rounded-full hover:opacity-80 transition-opacity"
                >
                  <svg
                ...
                <a
                  href="https://github.com/Dharnishan"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#333] text-white p-3 rounded-full hover:opacity-80 transition-opacity"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                ...
                <a
                  href="https://www.instagram.com/dharnish_0410"
                  target="_blank"
                  rel="noopener noreferrer"
